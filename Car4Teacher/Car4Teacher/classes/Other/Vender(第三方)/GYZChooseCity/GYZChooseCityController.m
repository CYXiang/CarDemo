...
-(void)viewDidLoad{
    ...
    UIBarButtonItem *cancelBarButton = [UIBarButtonItem itemWithTitle:@"取消" Target:self action:@selector(cancelButtonDown:) image:nil highImage:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section < 3) {
        ...
        if (indexPath.section == 0) {
            ...
            cell.noDataLabel.text = @"未能获取到您的位置，请手动选择城市";
